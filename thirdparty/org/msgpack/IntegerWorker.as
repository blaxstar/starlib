...
//
package net.blaxstar.starlib.thirdparty.org.msgpack {
    import flash.utils.*;

    internal class IntegerWorker extends Worker {
        public static function checkType(byte:int):Boolean {
            return (byte & 0x80) == 0 || (byte & 0xe0) == 0xe0 || byte == 0xcc || byte == 0xcd || byte == 0xce || byte == 0xcf || byte == 0xd0 || byte == 0xd1 || byte == 0xd2 || byte == 0xd3;
        }
