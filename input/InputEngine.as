package net.blaxstar.starlib.input {
  ...
  public class InputEngine extends Sprite {
    ...
    public function getController(player_id:uint):Gamepad {
      ...
      if (controllers > 0 ) {
        ...
        if (player_id > controllers) {
          ...
          DebugDaemon.write_log("controller #%s not detected!", DebugDaemon.ERROR_GENERIC, player_id);
        } else {
     ...
     * @return void
     */
    public function add_mouse_listener(listener_type:String,
     ...
     * @return void
     */
    public function add_keyboard_delegate(delegate:Function,
    key_event_trigger:uint = 0):void {
